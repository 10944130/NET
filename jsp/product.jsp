...
//Step 5: 顯示結果      
		...
		out.print("<form action='addcart.jsp' method='POST' name='form"+rs1.getString(1)+"'>");
		out.print("<div class='item-money'><p>NT$"+rs1.getString(7)+"</p>");
		out.print("</div>");
		out.print("<div class='item-cart'>");
		out.print("<form method='post' id='cart' name='人數'>");
		out.print("<div class='item-cart-people'>人數:"+"</div>");
		out.print("<input type='number' min='1' name='人數' id='item-cart-number'>");								
...
<%
if(session.getAttribution("id")!=null){}
try {
//Step 1: 載入資料庫驅動程式 
    Class.forName("com.mysql.jdbc.Driver");
    try {
