...
if(session.getAttribute("id") != null ){
    sql = "SELECT * FROM `backcount` WHERE `id`='" +session.getAttribute("id")+"';"; 
...
%>
    <section>
        <h2 class="sale-glowIn">
            ...
            <span style="animation-delay: 0.6s">資</span>
            <span style="animation-delay: 0.9s">訊</span>
        </h2>
                ...
                <div class="loginall-loginform">
                    <div class="loginall-signinform">
                        ...
                        <div class="loginall-group">
                                ...
                                <input type="checkbox" onclick="showpassword()" data-type="text"  ><font class="font">顯示密碼</font></form>
                        </div>
                        <div class="loginall-group">
                            <a href="backstage.jsp"><input type="submit" class="button" value="後台管理" ></a> 
