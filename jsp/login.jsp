                ...
                <div class="loginall-loginform">
                    ...
                    <div class="loginall-signupform">
						...
						<form action="user.jsp" method="POST">	
                            <label for="account" class="label">帳號</label>
                            <input id="account" type="text" class="input" placeholder="請設定帳號" name="nid">
                        </div>
                        <div class="loginall-group">
                            <label for="setpass" class="label">密碼</label>
                            <input id="setpass" type="password" class="input" data-type="password" placeholder="請設定密碼" name="npwd">
                        </div>
                        <div class="loginall-group">
                            ...
                            <input type="checkbox" onclick="showsetpassword()" data-type="text" name="npwd"><font class="font">顯示密碼</font>
                        </div>
                        <div class="loginall-group">
                            <label for="setemail" class="label">信箱</label>
                            <input id="setemail" type="email" class="input" placeholder="請設定信箱地址" name="ngmail">
                        </div>
                        <div class="loginall-group">
                            <a href="member.jsp"><input type="submit" class="button" value="註冊" ></a></form>
                        </div>
                    </div>
                </div>
            </div> 
